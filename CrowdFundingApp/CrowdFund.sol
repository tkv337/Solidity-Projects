...
contract CrowdFund {
    ...
    function cancel(uint _id) {
        ...
        require(block.timestamp < campaign.startAt, "slow your roll");
    ...
    function pledge(uint _id, uint _amount) external {
        ...
        token.transferFom(msg.sender, address(this), _amount);
    ...
    function unpledge(uint _id, uint _amount) external {
        Campaign storage campaign = campaigns[_id];
        require(block.timestamp <= campaign.endAt, "already over");

        campaign.pledged -= _amount;
        pledgedAmount[_id][msg.sender] -= _amount;
        token.transfer(msg.sender, _amount);

        emit Unpledge(_id, msg.sennder, _amount);
    }
